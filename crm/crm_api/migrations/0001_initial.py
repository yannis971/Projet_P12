# Generated by Django 3.2.5 on 2021-08-31 10:28
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='EventStatus',
            fields=[
                ('event_status_id', models.BigAutoField(primary_key=True, serialize=False)),
        ...
        migrations.CreateModel(
            name='SupportContact',
            fields=[
                ('support_contact_id', models.BigAutoField(primary_key=True, serialize=False)),
        ...
        migrations.CreateModel(
            name='StaffContact',
            fields=[
                ('staff_contact_id', models.BigAutoField(primary_key=True, serialize=False)),
                ('user', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
            options={
        ...
        migrations.CreateModel(
            name='SalesContact',
            fields=[
                ('sales_contact_id', models.BigAutoField(primary_key=True, serialize=False)),
                ('user', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('event_date', models.DateTimeField(default=datetime.datetime(2021, 8, 31, 12, 28, 49, 496360))),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('payment_due', models.DateTimeField(default=datetime.datetime(2021, 8, 31, 12, 28, 49, 495010))),
                ('client', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='crm_api.client')),

# Generated by Django 3.2.5 on 2021-09-03 22:11
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('event_date', models.DateTimeField(default=datetime.datetime(2021, 9, 4, 0, 11, 48, 357516))),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('payment_due', models.DateTimeField(default=datetime.datetime(2021, 9, 4, 0, 11, 48, 356691))),
                ('client', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='crm_api.client')),

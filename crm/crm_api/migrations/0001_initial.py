    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('event_date', models.DateTimeField(default=datetime.datetime(2021, 8, 22, 14, 34, 51, 889674))),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('payment_due', models.DateTimeField(default=datetime.datetime(2021, 8, 22, 14, 34, 51, 888814))),
                ('client', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='crm_api.client')),

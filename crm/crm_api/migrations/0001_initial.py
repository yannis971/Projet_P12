    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('event_date', models.DateTimeField(default=datetime.datetime(2021, 9, 2, 11, 45, 59, 731032))),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('payment_due', models.DateTimeField(default=datetime.datetime(2021, 9, 2, 11, 45, 59, 729991))),
                ('client', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='crm_api.client')),
